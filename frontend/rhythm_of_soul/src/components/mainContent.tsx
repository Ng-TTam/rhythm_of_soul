      ...
      <div className="content-inner container-fluid pb-0" id="page_layout">
        <div className="row mb-5">
          ...
          <div className="col-xl-3 col-md-6 mb-3">
            <div className="bg-soft-danger position-relative  rounded-3 card-box mb-3 ">
              <img src="../assets/images/dashboard/01.png" className="img-fluid mx-auto d-block" alt="play-img" />
              <div className="d-flex align-items-center play-list-icon">
                <svg className="text-danger" width={22} height={22} viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <g id="Play">
                    <path
                      id="Fill 1"
                      opacity="0.4"
                ...
                <span className="ms-2 fw-semibold text-capitalize">12 tracks</span>
              </div>
            </div>
            <a href="music-player.html" className="text-capitalize h5">
              Eliana d’cruz playlist
            </a>
            <small className="fw-normal line-count-1 text-capitalize">top 12 songs from Eliana and all type of songs.</small>{" "}
          </div>
          <div className="col-xl-3 col-md-6 mb-3">
            <div className="bg-soft-warning position-relative  rounded-3 card-box mb-3 ">
              <img src="../assets/images/dashboard/02.png" className="img-fluid mx-auto d-block" alt="play-img" />
              <div className="d-flex align-items-center play-list-icon">
                <svg className="text-warning" width={22} height={22} viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <g id="Play">
                    <path
                      id="Fill 1"
                      opacity="0.4"
                ...
                <span className="ms-2 fw-semibold text-capitalize">18 tracks</span>
              </div>
            </div>
            <a href="music-player.html" className="text-capitalize h5">
              omen smith playlist
            </a>
            <small className="fw-normal line-count-1 text-capitalize">top 18 songs from omen and mainly party song.</small>{" "}
          </div>
          <div className="col-xl-3 col-md-6 mb-3">
            <div className="bg-soft-info position-relative  rounded-3 card-box mb-3 ">
              <img src="../assets/images/dashboard/03.png" className="img-fluid mx-auto d-block" alt="play-img" />
              <div className="d-flex align-items-center play-list-icon">
                <svg className="text-info" width={22} height={22} viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <g id="Play">
                    <path
                      id="Fill 1"
                      opacity="0.4"
                ...
                <span className="ms-2 fw-semibold text-capitalize">16 tracks</span>
              </div>
            </div>
            <a href="music-player.html" className="text-capitalize h5">
              Alexa Jonas
            </a>
            <small className="fw-normal line-count-1 text-capitalize">top 16 songs from Alexa and most of the relax songs.</small>{" "}
          </div>
          <div className="col-xl-3 col-md-6 mb-3">
            <div className="bg-soft-success position-relative  rounded-3 card-box mb-3 ">
              <img src="../assets/images/dashboard/04.png" className="img-fluid mx-auto d-block" alt="play-img" />
              <div className="d-flex align-items-center play-list-icon">
                <svg className="text-success" width={22} height={22} viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <g id="Play">
                    <path
                      id="Fill 1"
                      opacity="0.4"
                ...
                <span className="ms-2 fw-semibold text-capitalize">22 tracks</span>
              </div>
            </div>
            <a href="music-player.html" className="text-capitalize h5">
              vibrato eruct
            </a>
            <small className="fw-normal line-count-1 text-capitalize">top 22 songs from vibrato and all type of songs.</small>{" "}
          </div>
        </div>
        ...
        <div className="row  mb-5">
          <div className="col-lg-12">
            <div className="card-header mb-3">
              <div className="header-title d-flex align-items-center justify-content-between">
                <h4 className="card-title text-capitalize">radio station songs</h4>
                <a href="#" className="small text-body">
                  View All{" "}
                  <svg xmlns="http://www.w3.org/2000/svg" width={14} height={15} viewBox="0 0 14 15" fill="none">
                    <path
          ...
          <ul className="row row-cols-lg-5 row-cols-md-4  row-cols-2 list-unstyled mb-0">
            <li className="col mb-3">
              <img src="../assets/images/dashboard/45.png" className="mb-3 img-fluid rounded-3" alt="song-img" />
              <a href="music-player.html" className=" text-capitalize line-count-1 h5 d-block">
                music hits
              </a>
              <small className="fw-normal text-capitalize line-count-1">music hits by rj karuna</small>
            </li>
            <li className="col mb-3">
              <img src="../assets/images/dashboard/46.png" className="mb-3 img-fluid rounded-3" alt="song-img" />
              <a href="music-player.html" className=" text-capitalize line-count-1 h5 d-block">
                8917 radio hits
              </a>
              <small className="fw-normal text-capitalize line-count-1">897 radio hits by rj Nina</small>
            </li>
            <li className="col mb-3">
              <img src="../assets/images/dashboard/47.png" className="mb-3 img-fluid rounded-3" alt="song-img" />
              <a href="music-player.html" className=" text-capitalize line-count-1 h5 d-block">
                country music
              </a>
              <small className="fw-normal text-capitalize line-count-1">country music by rj angel</small>
            </li>
            <li className="col mb-3">
              <img src="../assets/images/dashboard/48.png" className="mb-3 img-fluid rounded-3" alt="song-img" />
              <a href="music-player.html" className=" text-capitalize line-count-1 h5 d-block">
                winter thunders
              </a>
              <small className="fw-normal text-capitalize line-count-1">winter thunders by rj myoma</small>
            </li>
            <li className="col mb-3">
              <img src="../assets/images/dashboard/49.png" className="mb-3 img-fluid rounded-3" alt="song-img" />
              <a href="music-player.html" className=" text-capitalize line-count-1 h5 d-block">
                radio with rive
              </a>
              <small className="fw-normal text-capitalize line-count-1">radio with rive from rj rive</small>
            </li>
          </ul>
        </div>
        <div className="row  mb-5">
          <div className="col-lg-12">
            <div className="card-header  mb-3">
              <div className="header-title">
                <h4 className="card-title text-capitalize">our top listening songs</h4>
              </div>
            </div>
          </div>
          <SongTop />
          ...
          <div className="card-body">
            <div className="d-flex align-items-center justify-content-between flex-md-row flex-column gap-3">
              <div className="">
                ...
                <small>
                  Copyright <span id="copyright"></span>. Made with love by Iqonic Design.
                </small>
              </div>
              <div>

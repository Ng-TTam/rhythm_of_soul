...
export default function SongRecentlyPlayback() {
  const songs = [
    { img: "11.png", title: "way of right", artist: "king sing" },
    { img: "12.png", title: "years of hundred", artist: "Helena illation" },
    { img: "13.png", title: "you are mine", artist: "you are mine" },
    { img: "14.png", title: "heart is beating", artist: "snoods smith jonas" },
    { img: "15.png", title: "my crying eyes", artist: "snoods smith jonas" },
    { img: "16.png", title: "my lovely dad", artist: "snoods smith jonas" },
    { img: "11.png", title: "the girl", artist: "snoods smith Jonas" },
  ];
        ...
        {songs.map((song, index) => (
          ...
          >
            <div className="card-body text-center p-2">
              <img
                src={`../assets/images/dashboard/${song.img}`}
              ...
              <a
                ...
                className="text-capitalize h6 d-block mb-1"
              >
                {song.title}
              </a>

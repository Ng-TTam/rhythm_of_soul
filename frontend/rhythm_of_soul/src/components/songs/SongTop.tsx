          ...
          <ul className="p-0 list-unstyled mb-0 ">
            <li className="pb-3 border-bottom">
              <div className="d-flex">
                <img
                  src="../assets/images/dashboard/22.png"
                  ...
                  <div>
                    <div>
                      <a
                        ...
                        className="text-capitalize h5 mt-3"
                      >
                        Saturday party
                      </a>
                    </div>
            ...
            <li className="py-3 border-bottom">
              <div className="d-flex">
                <img
                  src="../assets/images/dashboard/23.png"
                  className="img-fluid rounded me-3 avatar-55"
                  alt="list-img"
                />
                <div className="d-flex align-items-center justify-content-between flex-wrap w-100">
                  <div>
                    ...
                    <small className="text-capitalize">angle wings</small>
                  </div>
                  <div className="d-flex align-items-center heading-color">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                    ...
                    <small className="ms-2">8.2k</small>
                  </div>
                </div>{" "}
              </div>
            </li>
              ...
              <div className="d-flex">
                ...
                <div className="d-flex align-items-center justify-content-between flex-wrap w-100">
                  <div>
                    ...
                    <small className="text-capitalize">smith euc</small>
                  </div>
                  <div className="d-flex align-items-center heading-color">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                    ...
                    <small className="ms-2">8.0k</small>
                  </div>
                </div>{" "}
              </div>
            </li>
              ...
              <div className="d-flex">
                ...
                <div className="d-flex align-items-center justify-content-between flex-wrap w-100">
                  <div>
                    ...
                    <small className="text-capitalize">karuna Williams</small>
                  </div>
                  <div className="d-flex align-items-center heading-color">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                    ...
                    <small className="ms-2">7.6k</small>
                  </div>
                </div>{" "}
              </div>
            </li>

        ...
        <div className="footer-bottom">
          <div className="container-fluid px-4">
            <div className="row align-items-center">
              <div className="col-xl-4 col-md-4 col-sm-6">
                <div className="details">
                  <div className="footer-track-detail d-flex align-items-center gap-3 flex-wrap justify-content-sm-start justify-content-center">
                    ...
                    <div>
                      <h6 className="track-name text-white font-size-14 mb-1" />
                      <p className="track-artist text-white small m-0" />
                    </div>
              ...
              <div className="col-xl-4 col-md-3 col-sm-6 mt-sm-0 mt-3">
                <div className="d-flex align-items-center justify-content-md-center justify-content-sm-end justify-content-center gap-3">
                  <div className="track-suffle text-white">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width={18}
                      height={18}
                  ...
                  <div className="prev-track text-white">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width={16}
                      height={16}
                  ...
                  <div className="playpause-track">
                    <span className="d-inline-block rounded-circle p-2 bg-primary text-white">
                      <svg
                        fill="none"
                        xmlns="http://www.w3.org/2000/svg"
                        width={24}
                  ...
                  <div className="next-track text-white">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width={16}
                      height={16}
                  ...
                  <div className="track-replay text-white">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width={16}
                      height={16}
              ...
              <div className="col-xl-4 col-md-5 mt-md-0 mt-3">
                <div className="row align-items-center gx-xl-5 justify-content-md-end justify-content-center">
                  <div className="col-lg-2 d-lg-block d-none" />
                  <div className="col-lg-4 col-md-5 col-sm-4 col-4">
                    <div className="track-volumne d-flex align-items-center justify-content-md-end justify-content-sm-start justify-content-center">
                  ...
                  <div className="col-lg-4 col-md-5 col-sm-4 col-5">
                    <div className="track-time text-center">
                      <span className="current-time text-white small">
                        00:00
                      </span>
                      <span className="mx-1 text-white">
                        ...
                        >
                          <path
                            d="M2.73047 0.392578H3.62109L0.890625 9H0L2.73047 0.392578Z"
                            fill="currentColor"
                          />
                        </svg>
                      </span>
                      <span className="total-duration text-white small">
                        00:00
                      </span>
                    </div>
                  </div>
                  <div className="col-lg-2 col-md-2 col-sm-4 col-3">
                    <ul className="list-unstyled m-0 p-0 d-flex align-items-center justify-content-sm-end justify-content-center">
                      ...
                      <li
                        className="nav-item iq-full-screen d-none d-xl-block ms-3"
                        id="fullscreen-item"
                      >
                        <a
                          href="#"
                        ...
                        >
                          <span className="btn-inner">
                            ...
                            <svg
                              className="full-normal-screen icon-32 d-none"
                              width={24}
                              height={24}
                              viewBox="0 0 24 24"
                              fill="none"

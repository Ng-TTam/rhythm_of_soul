    ...
    <>
      <aside className="sidebar sidebar-base sidebar-white sidebar-default" id="first-tour" data-toggle="main-sidebar" data-sidebar="responsive">
        <div className="sidebar-header d-flex align-items-center justify-content-center">
          ...
          <button className="sidebar-toggle" data-toggle="sidebar" data-active="true" style={{ border: "none" }}>
            <i className="icon">
          ...
          <div className="sidebar-list">
            <ul className="navbar-nav iq-main-menu" id="sidebar-menu">
              ...
              <li className="nav-item">
                <a className={`nav-link ${menuHome.some(item => item.path === location.pathname) ? 'active' : ''}`} data-bs-toggle="collapse" href="#home-menu" role="button" aria-expanded="false" aria-controls="home-menu">
                  <i className="icon" data-bs-toggle="tooltip" title="Dashboard" data-bs-placement="right">
                    <svg className="icon-20" xmlns="http://www.w3.org/2000/svg" width={20} height={20} viewBox="0 0 20 20" fill="none">
                      <g clipPath="url(#clip0_389_2893)">
                        ...
                        />
                        <path d="M1.25 16.875H18.75" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round" />
                        <path
                ...
                <ul className="sub-nav collapse" id="home-menu" data-bs-parent="#sidebar-menu">
                  {menuHome.map((menu) => (
                    <li className="nav-item" key={menu.id}>
                      ...
                      >
                        ...
                        <span className="item-name">{menu.label}</span>
                      </button>
                    </li>
                  ))}
                </ul>
        ...
        <div className="scrollbar-track scrollbar-track-x" style={{ display: "none" }}>
          <div className="scrollbar-thumb scrollbar-thumb-x" style={{ width: 258, transform: "translate3d(0px, 0px, 0px)" }} />
        </div>

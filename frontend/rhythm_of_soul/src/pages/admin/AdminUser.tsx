                        ...
                        <div className="card">
                            <div className="card-header">
                                <div className="d-flex align-items-center justify-content-between flex-wrap gap-3">
                                    ...
                                    <button className="btn btn-primary" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvaswriter" aria-controls="offcanvaswriter">+ Add New Writer</button>
                                </div>
                            </div>
                            <div className="offcanvas offcanvas-end" tabIndex={-1} id="offcanvaswriter" aria-labelledby="offcanvaswriterLabel">
                                ...
                                <div className="offcanvas-body">
                                    <form action="https://templates.iqonic.design/muzik/html/dashboard/admin/admin-writer.html">
                                        <div className="mb-3">
                                            <label htmlFor="writername" className="form-label">Category Name:</label>
                                            <input type="email" className="form-control" id="writername" />
                                        </div>
                                        <div className="mb-3">
                                            <label className="form-label" htmlFor="exampleInputEmail3">Email Input</label>
                                            <input type="email" className="form-control" id="exampleInputEmail3" defaultValue="markjhon@gmail.com" placeholder="Enter Email" />
                                        </div>
                                        <div className="mb-3">
                                        ...
                                        <div className="mb-3">
                                            <label className="form-label" htmlFor="exampleInputdate">Date Input</label>
                                            <input type="date" className="form-control" id="exampleInputdate" defaultValue="mm/dd/yyyy" />
                                        </div>
                                        <div className="mb-3">
                                ...
                                <div className="table-data-top table-responsive">
                                    <table className="table mb-0" id="datatable" data-toggle="data-table">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>01</td>
                                                <td><img src="../../assets/images/dashboard/writer-1.png" className="img-fluid rounded-3" alt="data-table-image" /></td>
                                                <td>Jhone Steben</td>
                                                <td>jhon@demo.com</td>
                                                <td>Jan 9, 1968</td>
                                                <td>20</td>
                                                ...
                                                <td>
                                                    <div className="d-flex align-items-center gap-3">
                                                        <a className="btn btn-soft-primary btn-icon btn-sm rounded-pill ms-2" href="#" role="button">
                                            ...
                                            <tr>
                                                <td>02</td>
                                                <td><img src="../../assets/images/dashboard/writer-2.png" className="img-fluid rounded-3" alt="data-table-image" /></td>
                                                <td>John Klok</td>
                                            ...
                                            <tr>
                                                <td>03</td>
                                                <td><img src="../../assets/images/dashboard/writer-3.png" className="img-fluid rounded-3" alt="data-table-image" /></td>
                                                <td>Ichae Semos</td>
                                            ...
                                            <tr>
                                                <td>04</td>
                                                <td><img src="../../assets/images/dashboard/writer-4.png" className="img-fluid rounded-3" alt="data-table-image" /></td>
                                                <td>Jules Boutin</td>
                                            ...
                                            <tr>
                                                <td>05</td>
                                                <td><img src="../../assets/images/dashboard/writer-5.png" className="img-fluid rounded-3" alt="data-table-image" /></td>
                                                <td>Kusti Franti</td>
                                            ...
                                            <tr>
                                                <td>06</td>
                                                <td><img src="../../assets/images/dashboard/writer-6.png" className="img-fluid rounded-3" alt="data-table-image" /></td>
                                                <td>David King</td>

                    ...
                    <div className="col-lg-12">
                            ...
                            <div className="card-header">
                                <div className="d-flex align-items-center justify-content-between flex-wrap gap-3">
                                    ...
                                    <button className="btn btn-primary" type="button" data-bs-toggle="offcanvas"
                                        data-bs-target="#offcanvassong" aria-controls="offcanvassong">+ Add New
                                        Song</button>
                                </div>
                            </div>
                            <div className="offcanvas offcanvas-end" tabIndex={-1} id="offcanvassong"
                                aria-labelledby="offcanvassongLabel">
                                ...
                                <div className="offcanvas-body">
                                    <form
                                        action="https://templates.iqonic.design/muzik/html/dashboard/admin/admin-song.html">
                                        <div className="mb-3">
                                        ...
                                        <div className="mb-3">
                                            <label htmlFor="customFile1" className="form-label custom-file-input">Singer
                                                Profile:</label>
                                        ...
                                        <div className="mb-3">
                                            ...
                                            <select className="form-select" aria-label="exampletwo">
                                                <option value="" disabled selected>
                                                    Song Category
                                                </option>                                                <option>Filmi Song</option>
                                                <option>Surf Song</option>
                                                <option>Sed Song</option>
                                                <option>Falling Song</option>
                                                <option>Rock songs</option>
                                        ...
                                        <div className="mb-3">
                                            ...
                                            <select className="form-select" aria-label="examplethree">
                                                <option value="" disabled selected>
                                                    Song Category
                                                </option>                                                <option>Jhone Steben</option>
                                        ...
                                        <div className="mb-3">
                                            ...
                                            <textarea className="form-control" id="writerdescription" rows={5}></textarea>
                                        </div>
                                ...
                                <div className="table-data-top table-responsive">
                                    <table className="table mb-0" id="datatable" data-toggle="data-table">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>01</td>
                                                <td><img src="../../assets/images/dashboard/14.png"
                                                    className="img-fluid avatar-50 rounded-3" alt="data-table-image" /></td>
                                                ...
                                                <td>
                                                    <div className="d-flex align-items-center gap-3">
                                                        <a className="btn btn-soft-primary btn-icon btn-sm rounded-pill ms-2"
                                                            href="#" role="button">
                                            ...
                                            <tr>
                                                <td>02</td>
                                                <td><img src="../../assets/images/dashboard/16.png"
                                                    className="img-fluid avatar-50 rounded-3" alt="data-table-image" /></td>
                                                <td>My Lovely Dad</td>
                                                <td>Filmi Song</td>
                                                <td>Norman Jonas</td>
                                            ...
                                            <tr>
                                                <td>03</td>
                                                <td><img src="../../assets/images/dashboard/11.png"
                                                    className="img-fluid avatar-50 rounded-3" alt="data-table-image" /></td>
                                                <td>Way Of Right</td>
                                                <td>Rock Songs</td>
                                                <td>Ella Mai</td>
                                            ...
                                            <tr>
                                                <td>04</td>
                                                <td><img src="../../assets/images/dashboard/09.png"
                                                    className="img-fluid avatar-50 rounded-3" alt="data-table-image" /></td>
                                            ...
                                            <tr>
                                                <td>05</td>
                                                <td><img src="../../assets/images/dashboard/37.png"
                                                    className="img-fluid avatar-50 rounded-3" alt="data-table-image" /></td>
                                            ...
                                            <tr>
                                                <td>06</td>
                                                <td><img src="../../assets/images/dashboard/29.png"
                                                    className="img-fluid avatar-50 rounded-3" alt="data-table-image" /></td>
                        ...
                        <div className="card border-top mb-0">
                            <div className="card-body">
                                <div
                                    className="d-flex align-items-center justify-content-between flex-md-row flex-column gap-3">
                                    <div className="">
                                        <ul
                                            className="list-unstyled p-0 m-0 mb-3 text-capitalize d-flex gap-3 flex-md-nowrap flex-wrap">
                                            <li>about</li>
                                            <li>|</li>
                                            <li>terms of use</li>
                                            <li>|</li>

                        ...
                        <div className="row">
                          <div className="col-lg-6">
                            <div className="form-group">
                              ...
                              <input type="text" className="form-control" name="firstName" onChange={handleChange} value={form.firstName} id="full-name" placeholder="John" />
                          ...
                          <div className="col-lg-6">
                            <div className="form-group">
                              ...
                              <input type="text" className="form-control" name="lastName" id="last-name" onChange={handleChange} value={form.lastName} placeholder="Doe" />
                          ...
                          <div className="col-lg-6">
                            <div className="form-group">
                              ...
                              <input type="email" className="form-control" name="email" onChange={handleChange} value={form.email} id="email" placeholder="xyz@example.com" />
                            ...
                            <div className="form-group">
                              ...
                              <input type="text" className="form-control" name="phoneNumber" onChange={handleChange} value={form.phoneNumber} id="phoneNuber" placeholder="123456789" />
                          ...
                          <div className="col-lg-6">
                            <div className="form-group">
                              ...
                              <input type="password" className="form-control" name="password" onChange={handleChange} value={form.password} id="password" placeholder=" " />
                          ...
                          <div className="col-lg-6">
                            <div className="form-group">
                              ...
                              <input type="password" className="form-control" name="confirmPassword" onChange={handleChange} value={confirmPassword} id="confirm-password" placeholder=" " />
                              {errorConfirmPassword && <small className="text-danger">{errorConfirmPassword}</small>}
                            </div>
                          </div>
                          <div className="col-lg-12 d-flex justify-content-center">
                            <div className="form-check mb-3">
                              <input type="checkbox" className="form-check-input" checked={agreed} onChange={(e) => setAgreed(e.target.checked)} id="customCheck1" />
                        ...
                        <div className="d-flex justify-content-center">
                          <ul className="list-group list-group-horizontal list-group-flush">
                            <li className="list-group-item border-0 pb-0">
                              <a href="#">
                                <img src="https://templates.iqonic.design/muzik/html/assets/images/brands/gm.svg" alt="gm" loading="lazy" />
                              </a>
                            </li>
                          </ul>
                        </div>

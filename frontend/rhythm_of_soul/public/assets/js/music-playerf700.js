...
let track_list = [
  {
    name: "Pop Smoke",
    artist: "Cascada",
    image: path + "assets/images/dashboard/audio/01.png",
    path: path + "assets/images/dashboard/audio/audio.mp3"
  },
  {
    name: "Gabby Barrett",
    artist: "Emeli Sande",
    image: path + "assets/images/dashboard/audio/02.png",
    path: path + "assets/images/dashboard/audio/audio.mp3"
  },
  {
    name: "Megan Thee",
    artist: "Jessie J",
    image: path + "assets/images/dashboard/audio/03.png",
    path: path +"assets/images/dashboard/audio/audio.mp3",
  },
];

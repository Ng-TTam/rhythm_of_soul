...
public enum ErrorCode {
    ...
    INVALID_DOB(2003, "Your age must be at least {min}", HttpStatus.BAD_REQUEST),
    ...
    INVALID_PHONE_NUMBER(2015, "Invalid phone number, phone number contain character 0-9 and length is 9-13", HttpStatus.BAD_REQUEST),
